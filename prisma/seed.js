...
try {
  if (isDev) {
    ...
    console.log('[SEED] [DEVELOPMENT] Database truncated');
  }
  ...
  if (authorCount === 0) {
    ...
    console.log('[SEED] Authors found in database skipping');
  }
  ...
  if (bookCount === 0) {
    ...
    console.log('[SEED] Books found in database skipping');
  }
  ...
  if (reviewCount === 0) {
    ...
    console.log('[SEED] Reviews found in database skipping');
  }
} catch (e) {
